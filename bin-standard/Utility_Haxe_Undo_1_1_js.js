...
org.puremvc.haxe.utilities.undo = {}
org.puremvc.haxe.utilities.undo.interfaces = {}
org.puremvc.haxe.utilities.undo.interfaces.IUndoableCommand = function() { }
org.puremvc.haxe.utilities.undo.interfaces.IUndoableCommand.__name__ = ["org","puremvc","haxe","utilities","undo","interfaces","IUndoableCommand"];
org.puremvc.haxe.utilities.undo.interfaces.IUndoableCommand.prototype.executeCommand = null;
org.puremvc.haxe.utilities.undo.interfaces.IUndoableCommand.prototype.getNote = null;
org.puremvc.haxe.utilities.undo.interfaces.IUndoableCommand.prototype.redo = null;
org.puremvc.haxe.utilities.undo.interfaces.IUndoableCommand.prototype.undo = null;
org.puremvc.haxe.utilities.undo.interfaces.IUndoableCommand.prototype.__class__ = org.puremvc.haxe.utilities.undo.interfaces.IUndoableCommand;
org.puremvc.haxe.utilities.undo.interfaces.IUndoableCommand.__interfaces__ = [org.puremvc.haxe.interfaces.INotifier,org.puremvc.haxe.interfaces.ICommand];
org.puremvc.haxe.utilities.undo.controller = {}
org.puremvc.haxe.utilities.undo.controller.UndoableCommandBase = function(p) { if( p === $_ ) return; {
	org.puremvc.haxe.patterns.command.SimpleCommand.apply(this,[]);
}}
org.puremvc.haxe.utilities.undo.controller.UndoableCommandBase.__name__ = ["org","puremvc","haxe","utilities","undo","controller","UndoableCommandBase"];
org.puremvc.haxe.utilities.undo.controller.UndoableCommandBase.__super__ = org.puremvc.haxe.patterns.command.SimpleCommand;
for(var k in org.puremvc.haxe.patterns.command.SimpleCommand.prototype ) org.puremvc.haxe.utilities.undo.controller.UndoableCommandBase.prototype[k] = org.puremvc.haxe.patterns.command.SimpleCommand.prototype[k];
org.puremvc.haxe.utilities.undo.controller.UndoableCommandBase.prototype._note = null;
org.puremvc.haxe.utilities.undo.controller.UndoableCommandBase.prototype.execute = function(note) {
	this._note = note;
	this.executeCommand();
	if(note.getType() == "RecordableCommand") {
		var historyProxy = function($this) {
			var $r;
			var tmp = $this.facade.retrieveProxy("CommandsHistoryProxy");
			$r = (Std["is"](tmp,org.puremvc.haxe.utilities.undo.model.CommandsHistoryProxy)?tmp:function($this) {
				var $r;
...
org.puremvc.haxe.utilities.undo.controller.UndoableCommandBase.prototype.executeCommand = function() {
	throw "The undoable command does not have 'executeCommand' method implemented.";
}
org.puremvc.haxe.utilities.undo.controller.UndoableCommandBase.prototype.getCommandName = function() {
	return this.getNote().getName();
}
org.puremvc.haxe.utilities.undo.controller.UndoableCommandBase.prototype.getNote = function() {
	return this._note;
}
org.puremvc.haxe.utilities.undo.controller.UndoableCommandBase.prototype.redo = function() {
	this.executeCommand();
}
org.puremvc.haxe.utilities.undo.controller.UndoableCommandBase.prototype.registerUndoCommand = function(cmdClass) {
	this.undoCmdClass = cmdClass;
}
org.puremvc.haxe.utilities.undo.controller.UndoableCommandBase.prototype.setNote = function(value) {
	this._note = value;
}
org.puremvc.haxe.utilities.undo.controller.UndoableCommandBase.prototype.undo = function() {
	...
	try {
	...
	catch( $e6 ) {
		{
			var e = $e6;
			{
				haxe.Log.trace("Undo command failed : " + Std.string(e),{ fileName : "UndoableCommandBase.hx", lineNumber : 112, className : "org.puremvc.haxe.utilities.undo.controller.UndoableCommandBase", methodName : "undo"});
			}
		}
	}
	this._note.setType(oldType);
}
org.puremvc.haxe.utilities.undo.controller.UndoableCommandBase.prototype.undoCmdClass = null;
org.puremvc.haxe.utilities.undo.controller.UndoableCommandBase.prototype.__class__ = org.puremvc.haxe.utilities.undo.controller.UndoableCommandBase;
org.puremvc.haxe.utilities.undo.controller.UndoableCommandBase.__interfaces__ = [org.puremvc.haxe.utilities.undo.interfaces.IUndoableCommand];
...
org.puremvc.haxe.utilities.undo.model = {}
org.puremvc.haxe.utilities.undo.model.CommandsHistoryProxy = function(data) { if( data === $_ ) return; {
	org.puremvc.haxe.patterns.proxy.Proxy.apply(this,["CommandsHistoryProxy",data]);
	this.undoStack = new Array();
	this.redoStack = new Array();
}}
org.puremvc.haxe.utilities.undo.model.CommandsHistoryProxy.__name__ = ["org","puremvc","haxe","utilities","undo","model","CommandsHistoryProxy"];
org.puremvc.haxe.utilities.undo.model.CommandsHistoryProxy.__super__ = org.puremvc.haxe.patterns.proxy.Proxy;
for(var k in org.puremvc.haxe.patterns.proxy.Proxy.prototype ) org.puremvc.haxe.utilities.undo.model.CommandsHistoryProxy.prototype[k] = org.puremvc.haxe.patterns.proxy.Proxy.prototype[k];
org.puremvc.haxe.utilities.undo.model.CommandsHistoryProxy.prototype.canRedo = null;
org.puremvc.haxe.utilities.undo.model.CommandsHistoryProxy.prototype.canUndo = null;
org.puremvc.haxe.utilities.undo.model.CommandsHistoryProxy.prototype.getCanRedo = function() {
	return this.redoStack.length > 0;
}
org.puremvc.haxe.utilities.undo.model.CommandsHistoryProxy.prototype.getCanUndo = function() {
	return this.undoStack.length > 0;
}
org.puremvc.haxe.utilities.undo.model.CommandsHistoryProxy.prototype.getNext = function() {
	if(this.redoStack.length > 0) {
		var cmd = function($this) {
			var $r;
			var tmp = $this.redoStack.pop();
			$r = (Std["is"](tmp,org.puremvc.haxe.utilities.undo.interfaces.IUndoableCommand)?tmp:function($this) {
				var $r;
				throw "Class cast error";
				return $r;
			}($this));
...
org.puremvc.haxe.utilities.undo.model.CommandsHistoryProxy.prototype.getPrevious = function() {
...
org.puremvc.haxe.utilities.undo.model.CommandsHistoryProxy.prototype.putCommand = function(cmd) {
	this.redoStack = new Array();
	this.undoStack.push(cmd);
...
org.puremvc.haxe.utilities.undo.model.CommandsHistoryProxy.prototype.redoStack = null;
org.puremvc.haxe.utilities.undo.model.CommandsHistoryProxy.prototype.undoStack = null;
org.puremvc.haxe.utilities.undo.model.CommandsHistoryProxy.prototype.__class__ = org.puremvc.haxe.utilities.undo.model.CommandsHistoryProxy;
org.puremvc.haxe.utilities.undo.model.CommandsHistoryProxy.__interfaces__ = [org.puremvc.haxe.interfaces.IProxy];
...
org.puremvc.haxe.utilities.undo.controller.UndoableMacroCommandBase = function(p) { if( p === $_ ) return; {
	org.puremvc.haxe.utilities.undo.controller.UndoableCommandBase.apply(this,[]);
	this.subCommands = new List();
	this.initializeMacroCommand();
}}
org.puremvc.haxe.utilities.undo.controller.UndoableMacroCommandBase.__name__ = ["org","puremvc","haxe","utilities","undo","controller","UndoableMacroCommandBase"];
org.puremvc.haxe.utilities.undo.controller.UndoableMacroCommandBase.__super__ = org.puremvc.haxe.utilities.undo.controller.UndoableCommandBase;
for(var k in org.puremvc.haxe.utilities.undo.controller.UndoableCommandBase.prototype ) org.puremvc.haxe.utilities.undo.controller.UndoableMacroCommandBase.prototype[k] = org.puremvc.haxe.utilities.undo.controller.UndoableCommandBase.prototype[k];
org.puremvc.haxe.utilities.undo.controller.UndoableMacroCommandBase.prototype.addSubCommand = function(commandClassRef) {
	this.subCommands.add(commandClassRef);
}
org.puremvc.haxe.utilities.undo.controller.UndoableMacroCommandBase.prototype.execute = function(note) {
	this.setNote(note);
	this.executeCommand();
	if(note.getType() == "RecordableCommand") {
		var historyProxy = function($this) {
...
org.puremvc.haxe.utilities.undo.controller.UndoableMacroCommandBase.prototype.executeCommand = function() {
	var noteType = this.getNote().getType();
	this.getNote().setType("NonRecordableCommand");
	{ var $it11 = this.subCommands.iterator();
	while( $it11.hasNext() ) { var subCommand = $it11.next();
	{
...
org.puremvc.haxe.utilities.undo.controller.UndoableMacroCommandBase.prototype.initializeMacroCommand = function() {
	haxe.Log.trace("'initializeMacroCommand' not implemented",{ fileName : "UndoableMacroCommandBase.hx", lineNumber : 35, className : "org.puremvc.haxe.utilities.undo.controller.UndoableMacroCommandBase", methodName : "initializeMacroCommand"});
}
org.puremvc.haxe.utilities.undo.controller.UndoableMacroCommandBase.prototype.subCommands = null;
org.puremvc.haxe.utilities.undo.controller.UndoableMacroCommandBase.prototype.__class__ = org.puremvc.haxe.utilities.undo.controller.UndoableMacroCommandBase;
org.puremvc.haxe.utilities.undo.controller.UndoableMacroCommandBase.__interfaces__ = [org.puremvc.haxe.utilities.undo.interfaces.IUndoableCommand,org.puremvc.haxe.interfaces.ICommand,org.puremvc.haxe.interfaces.INotifier];
org.puremvc.haxe.utilities.undo.enums = {}
org.puremvc.haxe.utilities.undo.enums.UndoableCommandTypeEnum = function() { }
org.puremvc.haxe.utilities.undo.enums.UndoableCommandTypeEnum.__name__ = ["org","puremvc","haxe","utilities","undo","enums","UndoableCommandTypeEnum"];
org.puremvc.haxe.utilities.undo.enums.UndoableCommandTypeEnum.prototype.__class__ = org.puremvc.haxe.utilities.undo.enums.UndoableCommandTypeEnum;
...
js.Lib.onerror = null;
org.puremvc.haxe.utilities.undo.model.CommandsHistoryProxy.NAME = "CommandsHistoryProxy";
org.puremvc.haxe.utilities.undo.model.CommandsHistoryProxy.UNDO_ENABLED = "undoEnabled";
org.puremvc.haxe.utilities.undo.model.CommandsHistoryProxy.UNDO_DISABLED = "undoDisabled";
org.puremvc.haxe.utilities.undo.model.CommandsHistoryProxy.REDO_ENABLED = "redoEnabled";
org.puremvc.haxe.utilities.undo.model.CommandsHistoryProxy.REDO_DISABLED = "redoDisabled";
org.puremvc.haxe.utilities.undo.model.CommandsHistoryProxy.COMMAND_HISTORY_UPDATED = "commandHistoryUpdated";
org.puremvc.haxe.utilities.undo.enums.UndoableCommandTypeEnum.RECORDABLE_COMMAND = "RecordableCommand";
org.puremvc.haxe.utilities.undo.enums.UndoableCommandTypeEnum.NON_RECORDABLE_COMMAND = "NonRecordableCommand";
